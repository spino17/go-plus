...
// This is a bootstrap copy of /Users/bhavyabhatt/Desktop/bhavya/projects/go-plus/src/debug/macho/file.go

//line /Users/bhavyabhatt/Desktop/bhavya/projects/go-plus/src/debug/macho/file.go:1
...
func NewFile(r io.ReaderAt) (*File, error) {
	...
	for i := uint32(0); i < f.Ncmd; i++ {
		...
		case LoadCmdDysymtab:
			...
			if f.Symtab == nil {
				return nil, &FormatError{offset, "dynamic symbol table seen before interface{} ordinary symbol table", nil}

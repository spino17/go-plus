...
// This is a bootstrap copy of /Users/bhavyabhatt/Desktop/bhavya/projects/go-plus/src/sort/gen_sort_variants.go

//line /Users/bhavyabhatt/Desktop/bhavya/projects/go-plus/src/sort/gen_sort_variants.go:1
...
func partialInsertionSort{{.FuncSuffix}}{{.TypeParam}}(data {{.DataType}}, a, b int {{.ExtraParam}}) bool {
	const (
		...
		shortestShifting = 50 // don't shift interface{} elements on short arrays
	)
	i := a + 1

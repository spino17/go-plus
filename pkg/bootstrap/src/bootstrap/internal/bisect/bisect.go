...
// This is a bootstrap copy of /Users/bhavyabhatt/Desktop/bhavya/projects/go-plus/src/internal/bisect/bisect.go

//line /Users/bhavyabhatt/Desktop/bhavya/projects/go-plus/src/internal/bisect/bisect.go:1
...
// Marker returns the match marker text to use on interface{} line reporting details
...
func Hash(data ...interface{}) uint64 {
	...
	for _, v := range data {
		...
		default:
			...
			// without interface{} allocation. It should be clear from the
...
// Each cache entry is N-way set-associative: h can appear in interface{} of the slots.
// If h does not appear in interface{} of them, then it is inserted into a random slot,
